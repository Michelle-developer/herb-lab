...
function ConstitutionToast({ type }) {
  ...
  return (
    <div className="fixed top-4 left-8 z-50 rounded bg-white/90 px-4 py-2 text-sm text-gray-600 shadow-md md:text-base lg:text-lg">
      {relatedMessage}
    </div>
  );
}

ConstitutionToast.PropTypes = {
  type: PropTypes.string.isRequired,
};

export default ConstitutionToast;
